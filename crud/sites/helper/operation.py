...
class Operation(object):
    ...
    @staticmethod
    def update(param: dict = None, obj: models.Model = None, is_header=None):
        """
        :param param:
        :param obj:
        :param is_header:
    ...
    @staticmethod
    def delete(param: dict = None, obj: models.Model = None, is_header=None):
        """
        :param param:
        :param obj:
        :param is_header:
    ...
    @staticmethod
    def detail(param: dict = None, obj: models.Model = None, is_header=None):
        """
        :param param:
        :param obj:
        :param is_header:
